 ...
 * @property-read \App\Domain\Feed\Models\FeedCategory|null $category
 * @property-read GeoContinent|null $continent
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Domain\Feed\Models\FeedMedia> $media
 * @property-read int|null $media_count
 * @property-read Member $member
 * @property-read MemberProfile $profile
 * @property-read GeoRegion|null $region
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Domain\Feed\Models\FeedPostThumb> $thumbs
 * @property-read int|null $thumbs_count
 * @property-read User $user
 * @method static \App\Domain\Feed\Database\Factories\FeedPostFactory factory($count = null, $state = [])
