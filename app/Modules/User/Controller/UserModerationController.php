...
use App\Modules\User\Requests\UserModerationRequest;
use App\Modules\User\Requests\UserModerationUpdateRequest;
use App\Modules\User\Resources\UserModerationResource;
use App\Modules\User\Service\UserModerationService;
...
class UserModerationController extends Controller
{
    ...
    {
        /** @var \App\Modules\User\Models\User $admin */
        $admin = Auth::user();
