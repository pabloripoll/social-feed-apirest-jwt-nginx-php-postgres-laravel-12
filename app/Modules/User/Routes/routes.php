...
use App\Modules\User\Controller\UserAdminController;
use App\Modules\User\Controller\UserAuthController;
use App\Modules\User\Controller\UserMemberController;
use App\Modules\User\Controller\UserModerationCategoryController;
use App\Modules\User\Controller\UserModerationController;
use App\Modules\User\Controller\UserModerationSanctionController;
use Illuminate\Support\Facades\Route;

Route::prefix('/api/v1')->name('api-v1.')->group(function () {

    Route::prefix('/auth')->name('auth.')->group(function () {
        Route::get('/activate/{code}', [UserAuthController::class, 'activate'])->name('activate');
