 ...
 * @method static \App\Modules\User\Database\Factories\UserModerationSanctionFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\App\Modules\User\Database\Factories\UserModerationSanctionFactory> */
    use HasFactory;
    ...
    {
        return \App\Modules\User\Database\Factories\UserModerationSanctionFactory::new();
    }
