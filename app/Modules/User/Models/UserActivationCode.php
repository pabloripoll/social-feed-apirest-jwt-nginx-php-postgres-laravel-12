...
use App\Modules\User\Database\Factories\UserActivationCodeFactory;
 ...
 * @method static \App\Modules\User\Database\Factories\UserActivationCodeFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\App\Modules\User\Database\Factories\UserActivationCodeFactory> */
    use HasFactory;
