...
use App\Modules\Member\Database\Factories\MemberAccessLogFactory;
 ...
 * @method static \App\Modules\Member\Database\Factories\MemberAccessLogFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\App\Modules\Member\Database\Factories\MemberAccessLog> */
    use HasFactory;
