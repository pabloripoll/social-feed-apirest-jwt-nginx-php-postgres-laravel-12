...
use App\Modules\Member\Database\Factories\MemberProfileFactory;
 ...
 * @method static \App\Modules\Member\Database\Factories\MemberProfileFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\App\Modules\Member\Database\Factories\MemberProfileFactory> */
    use HasFactory;
