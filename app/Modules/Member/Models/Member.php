...
use App\Modules\Member\Database\Factories\MemberFactory;
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Modules\Member\Models\MemberAccessLog> $accessLogs
 * @property-read int|null $access_logs_count
 * @property-read \App\Modules\Member\Models\MemberAvatar|null $avatar
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Modules\Member\Models\MemberAvatar> $avatars
 * @property-read int|null $avatars_count
 * @property-read GeoContinent|null $continent
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Modules\Member\Models\MemberFollower> $followers
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Modules\Member\Models\MemberFollower> $following
 * @property-read \App\Modules\Member\Models\MemberAccessLog|null $latestAccessLog
 * @property-read \Illuminate\Database\Eloquent\Collection<int, UserNotification> $notifications
 * @property-read int|null $notifications_count
 * @property-read \App\Modules\Member\Models\MemberProfile|null $profile
 * @property-read GeoRegion|null $region
 * @property-read User $user
 * @method static \App\Modules\Member\Database\Factories\MemberFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\App\Modules\Member\Models\MemberFactory> */
    use HasFactory;
