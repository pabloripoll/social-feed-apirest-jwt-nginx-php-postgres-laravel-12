 ...
 * @method static \App\Modules\Admin\Database\Factories\AdminProfileFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\App\Modules\Admin\Database\Factories\AdminProfileFactory> */
    use HasFactory;
