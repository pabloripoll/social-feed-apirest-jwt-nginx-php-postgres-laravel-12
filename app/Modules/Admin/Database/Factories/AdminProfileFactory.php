...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Modules\Admin\Models\AdminProfile>
 */
class AdminProfileFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'nickname' => $this->faker->regexify('[A-Za-z0-9]{8,64}'),
     ...
     *
     * This will create a AdminProfile nickname and a readable name from the user's email.
     */
    public function configure()
    {
        return $this->afterCreating(function (AdminProfile $profile) {
