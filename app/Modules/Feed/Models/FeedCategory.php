 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Modules\Feed\Models\FeedPost> $posts
...
{
    /** @use HasFactory<\App\Modules\Feed\Database\Factories\FeedCategoryFactory> */
    use HasFactory;
